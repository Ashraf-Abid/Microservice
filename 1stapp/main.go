...
func main() {
	...
	p := Productdetails{}
	//q:=newstruct{}
	clientOptions := options.Client().ApplyURI("mongodb://dummy:dummy@mongoservice:27017")

	//clientOptions := options.Client().ApplyURI("mongodb://mongoservice:27017")
	// Connect to MongoDB
...
func getProduct(id string) (*Response, error) {
	...
	client := &http.Client{}
	req, err := http.NewRequest(http.MethodGet, "http://productservice:8000/products/"+id, nil)
	if req != nil {
